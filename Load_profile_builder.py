...
main_3['P_el'] = df['P_el'].groupby(group).transform('mean')
...
main_2.to_parquet(f"Load_profiles/synPRO_el_family_main_2.parquet", engine="pyarrow", compression="zstd",compression_level=7,use_dictionary=True,)
main_3.to_parquet(f"Load_profiles/synPRO_el_family_main_3.parquet", engine="pyarrow", compression="zstd",compression_level=7,use_dictionary=True,)
