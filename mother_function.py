...
def main_1(P=None,pf=None,Q=None,Loadprofile_name=None):
    ...
    (time_period_df2, TjI_mean, TjD_mean, TjI_delta, TjD_delta, Nf_I, Nf_D,t_cycle_heat_I,t_cycle_heat_D) = Calculation_functions_class.downsample_arrays_df_2(group_size=f,
...
def main_2(P=None,pf=None,Q=None,Loadprofile_name=None):
    ...
    for chunk_start in range(0, num_secs, chunk_seconds):
        ...
        if is_last_chunk:
            print("Execution time last chunk:", end_time_chunk - start_time_chunk, "seconds")
